...
All notable changes to the **Squeak Peek** extension are documented in this file.
...
- Renamed the **History** command from _"Current (Working) File"_ to _"Show Position
  in History"_ and made it always available (`squeakPeek:enabled`) rather than gated behind a
  separate `squeakPeek:canCurrent` context.
...
- Initial release of Squeak Peek.
...
[1.0.0]: https://github.com/farengeyt451/squeak-peek/releases/tag/v1.0.0
[0.0.1]: https://github.com/farengeyt451/squeak-peek/releases/tag/v0.0.1
